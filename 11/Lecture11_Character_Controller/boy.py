...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, RSHIFT_DOWN, LSHIFT_DOWN, RSHIFT_UP, LSHIFT_UP, DASH_TIMER = range(10)
...
next_state_table = {
    ...
    SleepState: {LEFT_DOWN: RunState, RIGHT_DOWN: RunState,
                ...
                LSHIFT_DOWN: SleepState, RSHIFT_DOWN: SleepState,
                LSHIFT_UP: SleepState, RSHIFT_UP: SleepState,
                 },
